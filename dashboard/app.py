...
st.markdown('This dashboard shows the synthetic dataset and example site forecasts (XGBoost baseline).')
...
st.markdown('Use the `src/models/train_xgboost.py` script to train a model and the FastAPI to request predictions.')
