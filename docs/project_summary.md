...
- Feature modules (ev_forecast/features.py, ev_forecast/data_pipeline.py)
- XGBoost model and training pipeline (ev_forecast/models/, ev_forecast/training.py)
- FastAPI demo (ev_forecast/api/app.py)
- Streamlit dashboard (dashboard/app_new.py)
...
4. `python -m ev_forecast.training` (to train and save model)
5. `uvicorn ev_forecast.api.app:app --reload --port 8000`
6. `streamlit run dashboard/app_new.py`
