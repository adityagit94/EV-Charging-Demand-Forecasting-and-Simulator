...
class TestFeatureEngineer:
    ...
    def test_add_temporal_features_no_cyclical(self, feature_engineer, sample_hourly_data):
    ...
    def test_add_interaction_features(self, feature_engineer, sample_hourly_data):
        ...
        expected_interaction = df_with_features['hour_of_day'] * df_with_features['is_weekend']
        pd.testing.assert_series_equal(
            result['hour_of_day_x_is_weekend'],
...
class TestBackwardCompatibilityFunctions:
    ...
    def test_add_time_features_function(self, sample_hourly_data):
        ...
        expected_features = ['hour_of_day', 'day_of_week', 'is_weekend', 'hour_sin', 'hour_cos']
        for feature in expected_features:
            assert feature in result.columns
