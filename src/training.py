...
def main():
    ...
    parser = argparse.ArgumentParser(description='Train EV charging demand forecasting models')
    parser.add_argument('--data-path', type=str, help='Path to training data')
    parser.add_argument('--model', type=str, default='xgboost', help='Model type to train')
